//
//  GCTabBarSelectionIndicatorView.m
//  GameCall
//
...
@implementation GCTabBarSelectionIndicatorView

#pragma mark - GCTabBarSelectionIndicatorView

+ (GCTabBarSelectionIndicatorView *)sharedView {
    static GCTabBarSelectionIndicatorView *_sharedView = nil;
    static dispatch_once_t onceToken;
    
    dispatch_once(&onceToken, ^{
        _sharedView = [[GCTabBarSelectionIndicatorView alloc] initWithFrame:CGRectMake(0.f, 0.f, 55.f, 42.f)];
...
- (void)drawRect:(CGRect)rect {
    ...
    UIBezierPath* roundedRectanglePath = [UIBezierPath bezierPathWithRoundedRect: CGRectMake(0.f, 0.f, 54.f, 41.f) cornerRadius: 5.f];
    CGContextSaveGState(context);
    CGContextSetShadowWithColor(context, shadow2Offset, shadow2BlurRadius, shadow2.CGColor);
    CGContextBeginTransparencyLayer(context, NULL);
    [roundedRectanglePath addClip];
    CGContextDrawLinearGradient(context, gradient, CGPointMake(27.f, 0.f), CGPointMake(27.f, 41.f), 0.f);
